    ...
    document.getElementById('createplaylist').addEventListener('click', async function (event) {
        ...
        if (document.getElementById('singer').value != "") {
            ...
            document.getElementById('url').value = baselink + singer + singertext + trail;
        } else {
    ...
    //add an event to button listentosinger to call the click event of createplaylist button
    document.getElementById('listentosinger').addEventListener('click', async function () {
        //document.getElementById('playlistsection').style.display = 'block';
        event.preventDefault();
        document.getElementById('createplaylist').click();
    });

    //add an event to button listentosong to call the click event of createplaylist button

    document.getElementById('listentosong').addEventListener('click', function () {
        event.preventDefault();
        //save the value of singer
        var singer = document.getElementById('singer').value;
        //clear the value of singer 
        document.getElementById('singer').value = '';
        document.getElementById('createplaylist').click();
        //set the value of singer back
